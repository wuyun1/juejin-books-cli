...
<figure><img src="./_assets/img_1609449714985.png" /><figcaption></figcaption></figure>
...
<figure><img src="./_assets/img_1609449715091.gif" /><figcaption></figcaption></figure>

## 运行其他来源的代码块

当我在 `DevTools` 中预设了一组很棒的代码块以后，甚至都不必再通过 `Sources` 来运行它们。使用 `Command Menu` 才是最快的方式。只需在它的输入框中输入 `!` ，就可以根据名字来筛选预设代码块：

<figure><img src="./_assets/img_1609449715161.gif" /><figcaption></figcaption></figure>
